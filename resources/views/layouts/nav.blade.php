...
<div id="sidebar" class="sidebar"> 
   <div data-scrollbar="true" data-height="100%"> 
      ...
      <ul class="nav">
         ...
         <li class="has-sub {{ Request::is('chairmans') ? 'active' : '' }} {{ Request::is('parish-priest') ? 'active' : '' }} {{ Request::is('commission-heads') ? 'active' : '' }}  {{ Request::is('ppc') ? 'active' : '' }}  {{ Request::is('pfc') ? 'active' : '' }}  {{ Request::is('pfc-chairmans') ? 'active' : '' }}  "  style="border-bottom: 1px solid #46505a;
            ...
            <ul class="sub-menu">
               <li class="{{ Request::is('chairmans') ? 'active' : '' }}">  
                    <a class="" href=" /chairmans">
                         PPC Chairman lists
                    </a> 
                    </a> 
               <li class="{{ Request::is('pfc-chairmans') ? 'active' : '' }}">  
                    <a class="" href=" /pfc-chairmans">
                         PFC Chairman lists
                    </a> 
                    </a> 
                    
               <li class="{{ Request::is('parish-priest') ? 'active' : '' }}">
                    <a class="" href="/parish-priest">
                              Parish Priest lists
                      </a> 
            </li>    

            <li class="{{ Request::is('commission-heads') ? 'active' : '' }}">
                   <a class="" href="/commission-heads">
                             Commission Head lists
                   </a> 
            </li>  

            <li class="{{ Request::is('ppc') ? 'active' : '' }}">
                 <a class="" href="/ppc">
                         PPC lists
                    </a>   
            </li>   

            <li class="{{ Request::is('pfc') ? 'active' : '' }}"> 
                    <a class="" href="/pfc">
                         PFC lists
                    </a>  
            </li>
         ...
         <li><a href="javascript:;" class="sidebar-minify-btn" data-click="sidebar-minify"><i class="fa fa-compress"></i> <span> Collapse</span></a></li>
      </ul> 
   </div> 
</div>

...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card-header"style="background-color: #2580ff; color:white;"><b>{{ __('Edit Information') }}</b></div>
                <form method="POST" action="/pfc-chairmans/{{ $pfc_chairman->id }}" id="pfc_chairman-form">
                    @csrf
                    {{ method_field('PATCH') }}
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror" value="{{ $pfc_chairman->first_name }}">
                            @error('first_name')
                        ...
                        <div class="col">
                              ...
                              <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror" value="{{ $pfc_chairman->last_name }}">
                                @error('last_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group ">
                          ...
                          <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ $pfc_chairman->address }}">
                            @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="contact_no" class="form-control @error('contact_no') is-invalid @enderror" value="{{ substr($pfc_chairman->contact_no, 2) }}">
                                @error('contact_no')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col">
                          ...
                          <input type="date" name="birthday" class="form-control @error('birthday') is-invalid @enderror" value="{{ $pfc_chairman->birthday }}">
                            @error('birthday')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group ">
                          ...
                          <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" value="{{ $pfc_chairman->username }}">
                            @error('username')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group ">
                          <label>Email Address @error('email')<span class="text-danger"> *</span>@enderror </label>
                          <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $pfc_chairman->email }}">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
    ...
    function validateForm() {
        ...
        .then((willUpdate) => {
            if (willUpdate) {
                document.getElementById("pfc_chairman-form").submit();
            }
        });
    }
    </script>

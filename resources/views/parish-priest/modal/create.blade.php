<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.3/jquery.min.js"></script>
 <div class="modal fade" id="CreateParishPriest" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <div class="modal-header" style="background-color: #2580ff; color: white;">
      <h5 class="modal-title" id="exampleModalLabel">Add Parish Priest</h5>
      ...
      <div class="modal-body">
                ...
                <form method="POST" action="/parish-priests">
                    @csrf
                    <div class="card-body">
                        @if (session('status'))
  ...
  $('#clear-button').click(function() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        // reset form fields
        $('#CreateParishPriest form')[0].reset();
...
$('#CreateParishPriest form').on('submit', function(event) {

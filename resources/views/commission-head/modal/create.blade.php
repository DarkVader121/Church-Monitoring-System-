...
<div class="modal fade" id="CreateCommissionHead" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <div class="modal-header" style="background-color: #2580ff; color: white;">
      <h5 class="modal-title" id="exampleModalLabel">Add Commission Head</h5>
      ...
      <div class="modal-body">
                ...
                <form method="POST" action="/commission-heads">
                    @csrf
                    <div class="card-body">
                        @if (session('status'))
  ...
  $('#clear-button').click(function() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        // reset form fields
        $('#CreateCommissionHead form')[0].reset();
...
$('#CreateCommissionHead form').on('submit', function(event) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#CreateCommissionHead').modal('hide');
            location.reload();
        },
        error: function(xhr) {
            event.preventDefault();

...
<div class="modal fade" id="disable_user_{{ $id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="/chairmans/{{ $id }}/{{ $chairman->disabled ? 'enable' : 'disable' }}" style="display: inline-block;">
        @csrf
        {{ method_field('PATCH') }}
        <div class="card-body">
          @if (session('status'))
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-{{ $chairman->disabled ? 'success' : 'danger' }}">

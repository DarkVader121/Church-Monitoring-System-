...
aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-header" style="background-color: #2580ff; color: white;">
      <h5 class="modal-title" id="exampleModalLabel">Add Chairman</h5>
      ...
      <div class="modal-body">
                ...
                <form method="POST" action="/chairmans">
                    @csrf
                    <div class="card-body">
                        @if (session('status'))
                      ...
                      <div class="form-row">
                       <div class="form-group col-md-6">
                        ...
                        <div class="clearable-input">
                          <input type="date" name="birthday" max="<?php echo date("Y-m-d"); ?>" class="form-control @error('birthday') is-invalid @enderror" >
                          </div>
                          @error('birthday')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group ">
                          ...
                          <div class="clearable-input">
                          <input type="text"  name="email" class="form-control @error('email address') is-invalid @enderror" >
                          </div>
                         @error('email address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>

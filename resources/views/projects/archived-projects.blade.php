...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
            <div class="card-header" style="background-color: #f9bf00;  color:white;"><b>{{ __('Archived Projects') }}</b></div>
                    ...
                    <table class="table table-bordered" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-self-center text-center" style="color:#f9bf00;"><b>{{ $project->status }}</b></td>

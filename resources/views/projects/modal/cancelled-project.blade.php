...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="rejectModalLabel">
    <div class="modal-dialog" role="document">
      ...
      <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to reject this project?</h5>
      <button type="button" class="close" data-dismiss="modal" style="color: white"aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>
            <div class="modal-body">
                <p>Enter a reason for rejecting the project:</p>
                <textarea name="description" id="description"  style="width: 100%;"rows="4" class="form-control"></textarea>
            </div>
            <div class="modal-footer">
                
                <form method="POST" action="/projects/{{ $project->id }}/cancelled" id="rejectForm">
                    @csrf
                    {{ method_field('PATCH') }}

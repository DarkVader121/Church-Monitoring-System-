...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card-header"style="background-color: #2580ff; color:white;"><b>{{ __('Edit PPC Information') }}</b></div>
                <form method="POST" action="/ppcs/{{ $ppc->id }}" id="ppc-form">
                    @csrf
                    {{ method_field('PATCH') }}
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="form-group col-md-6">
                              ...
                              <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror" value="{{ $ppc->first_name}}">
                                @error('first_name')
                        ...
                        <div class="col">
                              ...
                              <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror" value="{{ $ppc->last_name }}">
                                @error('last_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group ">
                          ...
                          <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ $ppc->address }}">
                            @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="contact_no" class="form-control @error('contact_no') is-invalid @enderror" value="{{ substr($ppc->contact_no, 2) }}">
                                @error('contact_no')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col">
                          ...
                          <input type="date" name="birthday" class="form-control @error('birthday') is-invalid @enderror" value="{{ $ppc->birthday }}">
                            @error('age')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group ">
                          ...
                          <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" value="{{ $ppc->username }}">
                            @error('username')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
    ...
    function validateForm() {
        ...
        .then((willUpdate) => {
            if (willUpdate) {
                document.getElementById("ppc-form").submit();
            }
        });
    }
    </script>
